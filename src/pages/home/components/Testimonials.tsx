  ...
  return (
    <section id="testimonials" className="py-24 bg-gradient-to-b from-gray-900 to-gray-950 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="lg:grid lg:grid-cols-3 lg:gap-6 md:grid md:grid-cols-2 md:gap-6 flex md:flex-none overflow-x-auto gap-6 snap-x snap-mandatory scrollbar-hide pb-4 -mx-6 px-6">
          {testimonials.map((testimonial, index) => (
            <div
              key={index}
              onClick={() => setCurrentIndex(index)}
              className={`group cursor-pointer bg-gray-800/30 backdrop-blur-sm rounded-2xl p-6 border transition-all duration-300 flex-shrink-0 w-[70vw] md:w-auto snap-center ${
                currentIndex === index
