export default function Origin() {
  const milestones = [
    {
      title: '數據收集啟動',
      description: '系統性收集全球主要聯賽的比賽數據，建立基礎數據庫'
    },
    {
      title: '機器學習模型',
    ...
    {
      title: 'AI算法升級',
      description: '整合多維度數據分析，預測準確率突破70%'
    },
    {
      title: '實時預測系統',
    ...
    {
      title: '深度學習優化',
      description: '採用AI預測，處理200+數據維度，準確率提升至75%'
    },
    {
      title: '智能預測平台',
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center mb-20">
          ...
          <h2 className="text-6xl font-bold text-gray-900 mb-6" style={{ fontFamily: 'Noto Serif TC, serif' }}>
            技術演進<div className="text-emerald-500">多次進化</div>
          </h2>
        ...
        <div className="mt-24 grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            ...
            <div className="text-gray-600">數據分析維度</div>
            </div>
          <div className="bg-gradient-to-br from-emerald-50 to-white rounded-2xl p-8 border border-emerald-100">
